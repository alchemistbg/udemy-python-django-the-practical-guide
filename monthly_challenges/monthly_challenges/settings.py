...
SECRET_KEY = 'django-insecure-@2@gwnakc#5rkg$t$c#)7&^h88qkt2d!m!9bc#1lv#x&=)7@hb'
...
INSTALLED_APPS = [
    ...
    'challenges', # This register challenges as app
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            # BASE_DIR / 'challenges' / 'templates' # This register this folder as app specific template folder
            BASE_DIR / 'templates'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
